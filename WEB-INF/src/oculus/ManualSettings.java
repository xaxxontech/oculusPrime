...
public enum ManualSettings {
	...
	email_smtp_server, email_smtp_port, email_username, email_password, email_from_address, developer, 
	debugenabled, commandport, stopdelay, vself, arduinoprime, oculed;
	...
	public static Properties createDeaults(){
		...
		config.setProperty(arduinoprime.name(), Discovery.params.discovery.name());
